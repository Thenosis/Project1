...
//export of the fields to the record form
export default class OrderParts extends LightningElement {
    ...
    //event handler for when the record is successfully submitted
    handleSucess(event){}

    //event handler for when the record throws an error during submission
    handleError(event){}
